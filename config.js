...
config.IO_CHUNK_READ_CACHE_SIZE = 512 * 1024 * 1024;  // Was 256 * 1024 * 1024; // 20250428
...
config.IO_STREAM_SPLIT_SIZE = 512 * 1024 * 1024;  // was 32 * 1024 * 1024; // 20250428
...
config.IO_OBJECT_RANGE_ALIGN = 512 * 1024 *1024;  // was 32 * 1024 * 1024; // 20250428
